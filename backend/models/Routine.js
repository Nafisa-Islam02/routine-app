...
const routineSchema = new mongoose.Schema(
  {
    ...
    // Optional highlight colour, purely cosmetic — matches the colour-coding used on the
    // original paper/Excel routine (yellow = sessional/elective, cyan = lab, blue = HBK-taught
    // sessional, gray = theory highlight, orange = project course, neutral = admin block).
    color: { type: String, enum: ['', 'yellow', 'cyan', 'gray', 'blue', 'orange', 'neutral'], default: '' },
